...
<!-- >You can watch my outline video from [here]() -->
...
- [Live Demo on Github pages](https://yayaismaail.github.io/portfolio/)
...
```sh
git clone https://github.com/yayaismaail/portfolio.git
```

then you will see the **portfolio** on your system then type this:
...
Inside **portfolio** you can see `index.html` file double click it
...
Feel free to check the [issues page](https://github.com/yayaismaail/portfolio/issues).
